...
const EXAMPLE_QUESTIONS = [
  ...
  'Liegt ein aktueller Energieausweis vor und welche Energieeffizienzklasse hat das Objekt?',
...
export default function ChatInterface({ slug }) {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      {/* Chat Container */}
      <div className="flex-1 overflow-hidden flex flex-col max-w-4xl w-full mx-auto px-4 md:px-6 py-4">
        {/* Example Questions */}
        {messages.length === 0 && (
